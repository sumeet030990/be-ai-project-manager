...
_PREFIX = "/features/{feature_id}/stories/{story_id}/test-cases"
...
async def get_test_case(feature_id: uuid.UUID, story_id: uuid.UUID, test_case_id: uuid.UUID, db: DBSession):
    return await test_case_controller.get_test_case(
        feature_id=feature_id, story_id=story_id, test_case_id=test_case_id, db=db
    )
...
async def update_test_case(
    ...
    return await test_case_controller.update_test_case(
        feature_id=feature_id, story_id=story_id, test_case_id=test_case_id, payload=payload, db=db
    )
