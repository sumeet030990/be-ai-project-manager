...
async def update_feature(epic_id: uuid.UUID, feature_id: uuid.UUID, payload: FeatureUpdate, db: DBSession):
    return await feature_controller.update_feature(epic_id=epic_id, feature_id=feature_id, payload=payload, db=db)
